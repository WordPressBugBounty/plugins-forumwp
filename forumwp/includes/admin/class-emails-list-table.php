...
if ( ! class_exists( 'fmwp\admin\Emails_List_Table' ) ) {
	...
	class Emails_List_Table extends WP_List_Table {
		...
		protected function column_default( $item, $column_name ) {
			 ...
			 *
			 * @since 1.1.0
			 * @hook fmwp_emails_list_table_custom_column_content
			 *
			 ...
			 */
			return apply_filters( 'fmwp_emails_list_table_custom_column_content', '', $item, $column_name );
		}
		...
		protected function column_recipients( $item ) {
			...
			return esc_html__( 'Member', 'forumwp' );
		}
