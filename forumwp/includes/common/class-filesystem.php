...
if ( ! class_exists( 'fmwp\common\Filesystem' ) ) {
	...
	class Filesystem {
		...
		public function init_paths() {
			$this->temp_upload_dir = $this->get_upload_dir( 'forumwp/temp' );
		...
		public function clear_temp_dir() {
			 ...
			 *
			 * @since 2.1.0
			 * @hook fmwp_filesystem_max_file_age
			 *
			 * @param {int} $file_age Temp file age in seconds.
			 *
			 * @return {int} Temp file age in seconds.
			 */
			$file_age = apply_filters( 'fmwp_filesystem_max_file_age', 24 * 3600 ); // Temp file age in seconds
